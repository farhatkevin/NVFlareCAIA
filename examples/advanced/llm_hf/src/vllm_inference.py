...
def chat_interface_inference(model_name: str, messages_list: List[List[Dict[str, str]]], sampling_params: SamplingParams) -> None:
...
def main():
    ...
    parser.add_argument("--mode", type=str, choices=["basic", "chat", "chat_interface"], 
                       default="basic", help="Inference mode")
    ...
    parser.add_argument("--prompts_file", type=str, 
                       help="JSON file containing prompts or messages")
